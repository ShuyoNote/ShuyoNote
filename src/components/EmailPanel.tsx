...
// 低调入口：侧栏图标（无文字）+ 全局快捷键 Ctrl+Shift+E；面板为居中模态。
export function EmailPanel() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="email-modal-backdrop" onClick={closePanel}>
          <div className="email-modal" role="dialog" aria-label="邮箱" onClick={(e) => e.stopPropagation()}>
