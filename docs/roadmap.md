...
| **P2** | **帮助系统** | Notion / 思源 | 本地优先/键盘驱动的四层帮助（就地提示+快捷键面板+内置指南页）；帮助页=可编辑笔记，复用命令面板/模板/`shortcuts.ts` | 规划（**M25**，[方案](plans/2026-08-27-help-system-plan.md)） |
...
### M25 — 帮助系统（P2，[方案](plans/2026-08-27-help-system-plan.md)，规划/建议，未实装）
