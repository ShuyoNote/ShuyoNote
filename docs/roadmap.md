...
> 状态：**P0/P1 已落地（v1.59.177）**——快捷键面板 + 内置「使用指南」页 + 命令面板/斜杠入口；**P1 新手清单（空页引导「一键上手」：点一下即新建页/建库/开快捷键/试 AI）+ P2「关于」对话框（版本/许可/四外链 + 禁用外部导航开关）已落地**，见[项目网站导航方案](plans/2026-08-27-project-website-navigation-plan.md)；**P2 外部静态站本身待做**。
