...
| **P3** | AI 增强（薄 Agent 接口） | Obsidian AI / 思源 AI | 可选增强 + 本地倾向；不嵌入任意命令运行时 | 🗓 建议（[方案](plans/2026-08-24-thin-agent-interface-plan.md)：语义工具 + 受限宿主，写操作经审核） |
