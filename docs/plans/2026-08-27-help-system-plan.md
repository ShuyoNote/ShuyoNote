...
| **P2 · 外部帮助站点** | 静态文档站（复用 M21 静态 wiki 导出），应用内入口设计见[项目网站导航方案](2026-08-27-project-website-navigation-plan.md) | 站外 | 可选 | 未做 |
...
### P2（可选，看是否需要公开）
5. **帮助站点**：把「使用指南」页经 M21 静态 wiki 导出成网页；纯发现渠道，不是主形态。应用内到该站点的**入口设计（利弊 + 「关于」对话框 + 隐私开关）已细化**，见[项目网站导航方案](2026-08-27-project-website-navigation-plan.md)。
...
2. `/帮助` + 内置「使用指南」模板（P1）。
3. 空库引导 + 新手清单。
4. （可选）M21 静态 wiki 导出做站外帮助；应用内入口见[项目网站导航方案](2026-08-27-project-website-navigation-plan.md)。
