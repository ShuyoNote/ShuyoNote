...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.59.18-blue" alt="version">
...
- **网址书签**：`/wzsq` 或 `/bookmark` 插入 URL 为书签卡片（自动抓 Open Graph 标题/摘要/预览图）；粘贴纯网址可一键「转换为网址书签」；预览图复用附件内容寻址存储
