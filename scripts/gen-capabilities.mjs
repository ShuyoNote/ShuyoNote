...
export function genDocs(reg) {
  ...
  l.push("");
  l.push("完整可跑的零代码示例见 [`examples/plugins/reading-board/`](../examples/plugins/reading-board/)（一张表 + 两个可调设置，没有一行 JS）。");
  l.push("");
  ...
  l.push("- 需要权限 `export:files`（能力注册表里的写能力，风险等级 medium——它会把内容写到笔记之外）。");
  l.push("");
